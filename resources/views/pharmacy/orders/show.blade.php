    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <p class="info-item"><strong><i class="fas fa-store me-2"></i> المستودع :</strong> {{ $order->warehouse->user->name }}</p>
                <p class="info-item">
        ...
        <!-- زر الرجوع -->
        <div class="mt-4">
            <a href="{{ route('pharmacy.orders.index') }}" class="btn btn-primary"><i class="fas fa-arrow-right me-2"></i> رجوع</a>
        </div>
    </div>
</div>
@endsection
